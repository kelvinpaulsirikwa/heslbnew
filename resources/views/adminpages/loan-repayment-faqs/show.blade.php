                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                        <div>
                            <h2 class="mb-1 text-dark fw-bold">
                                ...
                                View Loan Repayment FAQ
                            </h2>
                            <p class="text-muted mb-0 small">Details of the frequently asked question</p>
                        </div>
                        <div class="d-flex gap-2">
                            <a href="{{ route('loan-repayment-faqs.edit', $faq->id) }}" class="btn btn-success px-4 py-2">
                ...
                <div class="bg-white shadow-sm border rounded-3 p-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="d-flex gap-2">
                                <span class="badge bg-success">Loan Repayment</span>
                    ...
                    <div class="d-flex flex-column flex-md-row gap-3 pt-4 border-top">
                        <a href="{{ route('loan-repayment-faqs.edit', $faq->id) }}" class="btn btn-success px-4">
                            <i class="fas fa-edit me-2"></i>Edit FAQ
                        </a>
                        ...
                        <a href="{{ route('loan-repayment-faqs.index') }}" class="btn btn-outline-secondary px-4">
                            <i class="fas fa-arrow-left me-2"></i>Back to List
                        </a>
                    </div>
                </div>
