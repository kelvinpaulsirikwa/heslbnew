        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-12">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                        <div>
                            <h2 class="mb-1 text-dark fw-bold">
                                ...
                                Add New Loan Repayment FAQ
                            </h2>
                            <p class="text-muted mb-0 small">Create a new frequently asked question for loan repayments</p>
                        </div>
                ...
                <div class="bg-white shadow-sm border rounded-3 p-4">
                    <form action="{{ route('loan-repayment-faqs.store') }}" method="POST">
                        @csrf
