        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-12">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                        <div>
                            <h2 class="mb-1 text-dark fw-bold">
                                ...
                                Edit Loan Repayment FAQ
                            </h2>
                            <p class="text-muted mb-0 small">Update the frequently asked question for loan repayments</p>
                        </div>
                        <a href="{{ route('loan-repayment-faqs.index') }}" class="btn btn-outline-secondary px-4 py-2">
                ...
                <div class="bg-white shadow-sm border rounded-3 p-4">
                    <form action="{{ route('loan-repayment-faqs.update', $faq->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            <label for="question" class="form-label fw-semibold text-dark">
                                <i class="fas fa-question-circle me-2 text-success"></i>Question
                            </label>
                        ...
                        <div class="mb-4">
                            ...
                            <small class="form-text text-muted d-block mt-1">Add step-by-step instructions to help citizens complete the loan repayment process</small>
                        </div>

                        <!-- Type Field (Hidden for Loan Repayment FAQs) -->
                        <input type="hidden" name="type" value="loan_repayment">
                        ...
                        <div class="d-flex flex-column flex-md-row gap-3 pt-3 border-top">
                            ...
                            <a href="{{ route('loan-repayment-faqs.index') }}" class="btn btn-outline-secondary btn-lg px-5">
