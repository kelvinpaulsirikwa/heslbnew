    ...
    <div class="container-fluid py-4">
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <div class="bg-white shadow-sm border rounded-3 p-4 mb-4">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                        <div>
                            ...
                            <p class="text-muted mb-0 small">Manage and organize government FAQs</p>
                        </div>
                        <a href="{{ route('faq.create') }}" class="btn btn-primary px-4 py-2">
                ...
                <div class="bg-white shadow-sm border rounded-3 mb-4">
                    <div class="card-header bg-light border-0 py-3">
                        <h4 class="mb-0 text-dark fw-semibold">
                            ...
                            <span class="badge bg-primary ms-2">{{ $faqs->where('type', 'loan_application')->count() }}</span>
                        </h4>
                    </div>
                    
                    <div class="card-body p-0">
                        @php
                            $loanApplicationFaqs = $faqs->where('type', 'loan_application');
                            $popularLoanApp = $loanApplicationFaqs->where('qnstype', 'popular_questions');
                            $generalLoanApp = $loanApplicationFaqs->where('qnstype', 'general_questions');
                        @endphp
                        
                        @if($loanApplicationFaqs->count() > 0)
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="p-3 bg-light bg-opacity-50 border-bottom">
                                        <h5 class="mb-0 text-dark fw-medium">
                                            ...
                                            Popular Questions
                                            <span class="badge bg-warning ms-2">{{ $popularLoanApp->count() }}</span>
                                        </h5>
                                    </div>
                                    
                                    @if($popularLoanApp->count() > 0)
                                        <div class="faq-items-container">
                                            @foreach($popularLoanApp as $faq)
                                                        ...
                                                        <div class="answer-content">
                                                            ...
                                                            <div class="faq-actions mt-3 pt-3 border-top">
                                                                <div class="d-flex flex-wrap gap-2">
                                                                    <a href="{{ route('faq.edit', $faq->id) }}" class="btn btn-outline-primary btn-sm">
                                                                        <i class="fas fa-edit me-1"></i>Edit
                                                                    </a>
                                                                    <a href="{{ route('faq.show', $faq->id) }}" class="btn btn-outline-info btn-sm">
                                ...
                                <div class="col-md-6">
                                    <div class="p-3 bg-light bg-opacity-50 border-bottom">
                                        <h5 class="mb-0 text-dark fw-medium">
                                            ...
                                            General Questions
                                            <span class="badge bg-info ms-2">{{ $generalLoanApp->count() }}</span>
                                        </h5>
                                    </div>
                                    
                                    @if($generalLoanApp->count() > 0)
                                        <div class="faq-items-container">
                                            @foreach($generalLoanApp as $faq)
                                                <div class="faq-item" id="faq-{{ $faq->id }}">
                                                    <div class="faq-question" onclick="toggleFAQ('faq-{{ $faq->id }}', this)">
                                                        <div class="faq-question-content">
                                                            <span class="question-text">{{ $faq->question }}</span>
                        ...
                        @else
                            <div class="text-center py-5">
                                ...
                                <h5 class="text-muted mt-3">No Loan Application FAQs</h5>
                                <p class="text-muted mb-0">No loan application questions have been added yet.</p>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="bg-white shadow-sm border rounded-3 mb-4">
                    <div class="card-header bg-light border-0 py-3">
                        <h4 class="mb-0 text-dark fw-semibold">
                            ...
                            Loan Repayment FAQs
                            <span class="badge bg-success ms-2">{{ $faqs->where('type', 'loan_repayment')->count() }}</span>
                        </h4>
                    </div>
                    
                    <div class="card-body p-0">
                        @php
                            $loanRepaymentFaqs = $faqs->where('type', 'loan_repayment');
                            $popularLoanRepay = $loanRepaymentFaqs->where('qnstype', 'popular_questions');
                            $generalLoanRepay = $loanRepaymentFaqs->where('qnstype', 'general_questions');
                        @endphp
                        
                        @if($loanRepaymentFaqs->count() > 0)
                            <div class="row">
                                <!-- Popular Questions Column -->
                                <div class="col-md-6">
                                    <div class="p-3 bg-light bg-opacity-50 border-bottom">
                ...
                <!-- Empty State (if no FAQs at all) -->
                    @if($faqs->isEmpty())
                    <div class="bg-white shadow-sm border rounded-3 text-center py-5">
                        <i class="fas fa-question-circle text-muted" style="font-size: 4rem;"></i>
                            <h4 class="text-muted mt-3">No FAQs Found</h4>
                            <p class="text-muted mb-4">Start by creating your first FAQ to help citizens find answers quickly.</p>
                            <a href="{{ route('faq.create') }}" class="btn btn-primary px-4">
