            ...
            <div class="card">
                <div class="card-header bg-light">
                    <div class="d-flex justify-content-between align-items-center">
                        <h3 class="card-title mb-0">Add Video Podcast</h3>
                ...
                <div class="card-body">
                    ...
                    <form id="videoPodcastsForm" action="{{ route('videopodcasts.store') }}" method="POST" data-admin-validation="videoPodcasts">
            @csrf
                        <!-- Video Name -->
                        <x-admin-form-field
                            type="text"
                ...
                <!-- Video Preview -->
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-success">
                                <i class="fas fa-save"></i> Save Video Podcast
                </button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const form = document.getElementById('videoPodcastsForm');
    if (form) {
    ...
    if (isValid && videoId) {
        ...
        previewDiv.innerHTML = `
            <img src="https://img.youtube.com/vi/${videoId}/maxresdefault.jpg" 
                ...
                <p class="mt-2 mb-0 text-muted">Video ID: ${videoId}</p>
        `;
