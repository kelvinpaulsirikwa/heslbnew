                ...
                <div class="bg-white shadow-sm border rounded-3 p-4 mb-4">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                        <div>
                            ...
                            <p class="text-muted mb-0 small">Manage and organize loan application FAQs</p>
                        </div>
                        <a href="{{ route('loan-application-faqs.create') }}" class="btn btn-primary px-4 py-2">
                ...
                <div class="bg-white shadow-sm border rounded-3 mb-4">
                    <div class="card-header bg-light border-0 py-3">
                        <h4 class="mb-0 text-dark fw-semibold">
                            <i class="fas fa-file-alt text-primary me-2"></i>
                            Loan Application FAQs
                            <span class="badge bg-primary ms-2">{{ $faqs->count() }}</span>
                        </h4>
                    </div>
                    
                    <div class="card-body p-0">
                        @php
                            $popularLoanApp = $faqs->where('qnstype', 'popular_questions');
                            $generalLoanApp = $faqs->where('qnstype', 'general_questions');
                        @endphp
                                                        ...
                                                        <div class="answer-content">
                                                            ...
                                                            <div class="faq-actions mt-3 pt-3 border-top">
                                                                <div class="d-flex flex-wrap gap-2">
                                                                    <a href="{{ route('loan-application-faqs.edit', $faq->id) }}" class="btn btn-outline-primary btn-sm">
                                                                        <i class="fas fa-edit me-1"></i>Edit
                                                                    </a>
                                                                    <a href="{{ route('loan-application-faqs.show', $faq->id) }}" class="btn btn-outline-info btn-sm">
